...
Convolution::Convolution(
    int height_in, int width_in, int kernel_width, int kernel_height, int channel_in, int channel_out, int stride) : 
    height_in(height_in), width_in(width_in), kernel_width(kernel_width), kernel_height(kernel_height),
